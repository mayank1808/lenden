...
(function($){
    ...
    $.fn.extend({
        ...
        resetSS: function(defaultValue){
            var oldOpts = $(this).data('ssOpts');
                if (defaultValue) {
                    if (!oldOpts) {
                        oldOpts = {};
                    }
                    oldOpts.defaultValue = defaultValue;
                }
                $this = $(this);
                $this.next().remove();
    ...
    $.fn.sSelect = function(options){
        return this.each(function(){
            ...
            var opts = $.extend(defaults, options),
                $input = $(this),
                $containerDivText    = $('<div class="selectedTxt">' + (opts.defaultValue ? opts.defaultValue : opts.defaultText ? opts.defaultText : '') + '</div>'),
